  ...
  return (
    <SafeAreaView className={styles.safeArea}>
      <KeyboardAvoidingView
        ...
        <ScrollView className={styles.scrollContent} keyboardShouldPersistTaps="handled">
          <View className={styles.header}>
            ...
            <TouchableOpacity>
              <Text className={styles.createAccount}>Or create a new account</Text>
            </TouchableOpacity>
          </View>
          ...
          <View className={styles.formContainer}>
              ...
              <View className={styles.inputWrapper}>
                ...
                <TextInput
                  ...
                  className={`${styles.textInput} ${
                    errors.email ? styles.inputError : styles.inputBorder
                  }`}
                />
              </View>
              {errors.email ? <Text className={styles.fieldError}>{errors.email}</Text> : null}
            </View>
            <View>
              <View className={styles.inputWrapper}>
                <View className={styles.inputIcon}>
                ...
                <TextInput
                  ...
                  secureTextEntry
                  className={`${styles.textInput} ${
                    errors.password ? styles.inputError : styles.inputBorder
                  }`}
                />
              </View>
              {errors.password ? (
            ...
            <TouchableOpacity>
              <Text className={styles.forgotPassword}>Forgot your password?</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              {isLoading ? <ActivityIndicator color="white" className={styles.spinner} /> : null}
...
const styles = {
  ...
  submitButton: 'h-12 flex-row items-center justify-center rounded-md bg-green-600',
